...
(function (app) {
	...
	app.factory('restaurantMockProvider', ['$http', 'rwApp.CONSTANTS', restaurantMockProvider]);
})(angular.module('rwApp'));
'use strict';
...
(function (app) {
	...
	app.factory('rwApp.restaurantService', ['restaurantMockProvider', restaurantService]);
})(angular.module('rwApp'));
'use strict';
